...
public class OAuthSwiftClient {
    ...
    public func post(urlString: String, parameters: Dictionary<String, AnyObject>, success: OAuthSwiftHTTPRequest.SuccessHandler?, failure: OAuthSwiftHTTPRequest.FailureHandler?) {
        ...
        //print("OAUTH_TOKEN_SECRET_REQUEST: URL:\(urlString) , Parameters:\(parameters)")
    ...
    public func request(url: String, method: String, parameters: Dictionary<String, AnyObject>, success: OAuthSwiftHTTPRequest.SuccessHandler?, failure: OAuthSwiftHTTPRequest.FailureHandler?) {
        if let request = makeRequest(url, method: method, parameters: parameters) {
          ...
          //  print("\n\nCall url:\(url)")
          //  print("\n\nCall method:\(url)")
          //  print("Call parameters:\(parameters)\n\n")
    ...
    public func requestWithHeaders(url: String, method: String, parameters: Dictionary<String, AnyObject>, headers: Dictionary<String, AnyObject>,success: OAuthSwiftHTTPRequest.SuccessHandler?, failure: OAuthSwiftHTTPRequest.FailureHandler?) {
        ...
        if let url = NSURL(string: url) {
            ...
            request.headers.updateValue("application/vnd.deere.axiom.v3+json", forKey: "Accept")
            
            //request.headers[Accept] =  "application/vnd.deere.axiom.v3+json"
